...
public class SettingsMenu {
	...
	// Components
	private static Scene scene_settings_menu;

	private static Label label_title, label_colorblind, label_mute;
	private static Button button_return;
	private static CheckBox checkBox_colorblind, checkBox_mute;
	...
	private static void onPressed_button_return(Stage context) {
